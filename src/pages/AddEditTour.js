...
export default function AddEditTour() {
  ...
  useEffect(() => {
    if (id) {
      const singleTour = userTours.find((tour) => tour.id == id);
  ...
  const handleSubmit = (e) => {
    ...
    if (title && description && tags) {
      ...
      const updatedTourData = { ...tourData, userId: loggedUser.id };
        ...
        <div className="form-box">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              {id && <img src={image} className="card-img-top img-thumbnail rounded" alt={title} />}
